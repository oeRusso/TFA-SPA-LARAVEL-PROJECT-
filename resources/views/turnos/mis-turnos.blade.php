...
@section('title', 'Mis Turnos - Belleza Spa')
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6 bg-gradient-to-r from-purple-600 to-indigo-600">
                ...
                <p class="text-purple-100 mt-2">Gestiona tus citas y reservas en Belleza Spa</p>
            </div>
        </div>
                ...
                <div class="flex items-center p-4 bg-blue-50 rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-blue-700 mt-1">
                            Esta sección está en desarrollo. Aquí podrás ver tus turnos agendados, historial de citas y reservar nuevos turnos.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <h3 class="text-lg font-semibold text-gray-800 mb-4">Tus Próximos Turnos</h3>
                ...
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-4 text-lg font-medium text-gray-900">No tienes turnos agendados</h3>
                    <p class="mt-2 text-sm text-gray-500">
                        Cuando esta funcionalidad esté lista, podrás agendar tus turnos aquí.
                    </p>
                    <div class="mt-6">
                        <button
                            type="button"
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800">Turnos Completados</h3>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800">Turnos Pendientes</h3>
                    <p class="text-3xl font-bold text-gray-900 mt-2">0</p>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800">Total de Servicios</h3>
                    <p class="text-3xl font-bold text-gray-900 mt-2">0</p>
                </div>
            </div>
        </div>
